...
public class TreeEbon implements ITreeMapping {

	@Override
	public void placeLog(World world, BlockPos pos, EnumFacing.Axis axis) {
		world.setBlockState(pos, InfernalBlocks.EBON_LOG.getDefaultState().withProperty(BasicLog.AXIS, axis));
	}

	@Override
	public void placeLeaves(World world, BlockPos pos) {
		world.setBlockState(pos, InfernalBlocks.EBON_LEAVES.getDefaultState().withProperty(BasicLeaves.CHECK_DECAY, false).withProperty(BasicLeaves.DECAYABLE, true));
	}
